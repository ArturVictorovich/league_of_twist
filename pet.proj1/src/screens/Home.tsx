...
function Home() {
  return (
    <div className="bg-card-bg-secondary relative flex h-dvh w-full flex-col items-center justify-center overflow-hidden">
      <div className="layout bg-app-bg scrollbar-hidden flex h-full min-h-0 w-full max-w-[390px] flex-col items-center overflow-y-auto px-2 py-4 min-[390px]:px-4 md:max-w-full md:overflow-hidden">
        <Header />
